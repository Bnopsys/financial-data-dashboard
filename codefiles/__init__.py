...
from .analytical_data import total_spending, avg_spending_per_cat, min_max_spending, top_n_spending_cats, find_top_five_purchases, debit_stats
...
__all__ = ['process_navy_fed', 'process_citi', 
           ...
           'top_n_spending_cats', 'debit_stats']